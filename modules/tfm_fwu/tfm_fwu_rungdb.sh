...
-ex "add-symbol-file freertos-tfm-fwu/freertos_kernel/portable/ThirdParty/GCC/ARM_CM33_TFM/build/RTOSDemo.axf" \
-ex "add-symbol-file tfm-fwu/cmake_build/bin/tfm_s.elf" \
-q